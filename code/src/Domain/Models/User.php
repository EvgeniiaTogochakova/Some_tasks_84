...
class User
{
    ...
    public static function getUserFromStorageById(int $id): User
    {
        ...
        $user = new User($result['user_name'], $result['user_lastname'], $result['user_birthday_timestamp'], $result['id_user']);
        return $user;
    }
    ...
    public function updateUser(array $userDataArray): void
    {
        ...
        $handler->execute(
            [
                'id_user' => $userDataArray['id_user'],
                'user_name' => $userDataArray['user_name'],
                'user_lastname'=>$userDataArray['user_lastname']
            ]
        );
    }
